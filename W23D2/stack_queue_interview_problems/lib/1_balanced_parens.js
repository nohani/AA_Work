...
function balancedParens(str) {
  ...
  const squareTotalModulo = (squareLeft + squareRight) % 2;
  const curlyTotalModulo = (curlyLeft + curlyRight) % 2;
  const curvyTotalModulo = (curvyLeft + curvyRight) % 2;

  if (squareTotalModulo === 0 && curlyTotalModulo === 0 && curvyTotalModulo === 0){
    return true;
  }
